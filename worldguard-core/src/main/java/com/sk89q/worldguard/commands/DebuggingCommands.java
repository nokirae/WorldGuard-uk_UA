...
public class DebuggingCommands {
    ...
    @Command(aliases = {"testbreak"}, usage = "[player]", desc = "Імітувати руйнування блоку", min = 1, max = 1, flags = "ts")
    ...
    @Command(aliases = {"testplace"}, usage = "[player]", desc = "Імітувати розміщення блоку", min = 1, max = 1, flags = "ts")
    @CommandPermissions("worldguard.debug.event")
    ...
    @Command(aliases = {"testinteract"}, usage = "[player]", desc = "Імітувати взаємодію з блоком", min = 1, max = 1, flags = "ts")
    @CommandPermissions("worldguard.debug.event")
    ...
    @Command(aliases = {"testdamage"}, usage = "[player]", desc = "Імітувати пошкодження сутності", min = 1, max = 1, flags = "ts")
    @CommandPermissions("worldguard.debug.event")
